 ...
 * Range Type
 */
if (!class_exists('Abp_Field_Type_Range'))
{
    class Abp_Field_Type_Range extends BP_XProfile_Field_Type
    {
        public function __construct() {
            parent::__construct();

            $this->name = __( 'Range Slider', 'abp' );
        ...
        ?>
            <div id="<?php echo esc_attr( $type ); ?>" class="postbox bp-options-box" style="<?php echo esc_attr( $class ); ?> margin-top: 15px;">
                <h3><?php esc_html_e( 'Write min and max values.', 'abp' ); ?></h3>
                <div class="inside">
                    <p>
                        <label for="<?php echo esc_attr( "{$type}_option1" ); ?>">
                            <?php esc_html_e('Minimum:', 'abp'); ?>
                        </label>
            ...
            <script>
                var error_msg_slider = '<?php esc_html_e("Min value cannot be bigger than max value.", "abp"); ?>',
                    error_msg_slider_empty = '<?php esc_html_e("You have to fill the two fields.", "abp"); ?>';
            </script>
        <?php
        }
        ...
        public static function display_filter($field_value, $field_id = '') {
             ...
             */
            return apply_filters('abp_slider_display_filter',
